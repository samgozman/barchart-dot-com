...
const overview = async (ticker = '') => {
    try {
        ...
        // Fix object keys
        overviewObj.fundamentals = fixKeys(overviewObj.fundamentals)
        overviewObj.options = fixKeys(overviewObj.options)
        overviewObj.analytics = fixKeys(overviewObj.analytics)
        overviewObj.estimates = fixKeys(overviewObj.estimates)
